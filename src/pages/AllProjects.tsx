...
const AllProjects = () => {
    ...
    return (
        <>
            ...
            <section className="px-5 md:px-10 py-20 min-h-screen">
                <div className="w-full max-w-7xl mx-auto px-5 md:px-10">
                    <TitleHeader
                        title="All Projects"
                        sub="🚀 Complete collection of my work✨"
                    />

                    {/* Back to Home Button */}
                    <div className="mt-8">
                        <a href="/" className="inline-flex items-center text-white-50 hover:text-white transition-colors">
